...
db=mysql.connector.connect(user='root',port=3306,database='breast cancer')
cur=db.cursor()

app = Flask(__name__)

app.config['UPLOAD_FOLDER']=r"C:\Users\YMTS0519\Documents\MAY-2022\BREAST CANCER\uploads"
app.config['SECRET_KEY']='b0b4fbefdc48be27a6123605f02b6b86'

global data, x_train, x_test, y_train, y_test

df = pd.read_csv('C:\\Users\\YMTS0519\\Documents\\MAY-2022\\BREAST CANCER\\DATASET\\data.csv')
